      ...
      <Box align="center" direction="column">
        <Box>
          <form onSubmit={this.handleSubmit}>
            ...
            <Box pad={{top: 'large', left: 'large'}} align="start" gap="none">
            ...
            { success == null ?
              <Box>
                <Box direction="row" gap="large" pad={{left: 'large'}}>
                ...
                <Box wrap pad={{ top: 'medium', left: 'large' }} align="start" gap="small">
                  <AxisTheme>
                    <CheckBox
                      id='toc_and_privacy'
                ...
                <Box pad={{ top: 'small', left: 'large' }} align="start" gap="large">
                  <Box direction="row" wrap align="start" gap="small">
                    {error && <Text style={{ color: 'red' }}>{error.message}</Text> }
                  </Box>
                </Box>
              </Box>
              : <Success success={success} polkascanUri={config.POLKASCAN_URI}></Success> }

            <Box pad="none" align="start" gap="none">
              <Disclaimer />
            </Box>
          </form>
        </Box>
